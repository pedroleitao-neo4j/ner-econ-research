...
python to_neo4j.py --input_csv results/all_pdfs_related_alternatives.csv --output_cypher results/all_pdfs_related_alternatives.cypher --alternative_suffix _alternative --add_alternative_columns org loc per subject_text --alternative_relationship ALTERNATIVE_VOCABULARY
